...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("{{ url_for('static', filename='lib/codemirror")); // Note non-packaged dependency diff_match_patch
  else if (typeof define == "function" && define.amd) // AMD
    define(["{{ url_for('static', filename='lib/codemirror", "diff_match_patch"], mod);
