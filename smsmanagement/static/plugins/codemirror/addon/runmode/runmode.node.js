...
require.cache[require.resolve("{{ url_for('static', filename='lib/codemirror")] = require.cache[require.resolve("./runmode.node")];
require.cache[require.resolve("{{ url_for('static', filename='addon/runmode/runmode")] = require.cache[require.resolve("./runmode.node")];
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    { mod(require("{{ url_for('static', filename='lib/codemirror")); }
  else if (typeof define == "function" && define.amd) // AMD
    { define(["{{ url_for('static', filename='lib/codemirror"], mod); }
