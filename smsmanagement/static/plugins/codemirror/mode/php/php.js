...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    mod(require("{{ url_for('static', filename='lib/codemirror"), require("../htmlmixed/htmlmixed"), require("../clike/clike"));
  else if (typeof define == "function" && define.amd) // AMD
    define(["{{ url_for('static', filename='lib/codemirror", "../htmlmixed/htmlmixed", "../clike/clike"], mod);
